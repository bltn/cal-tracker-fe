    ...
    render() {
        ...
        return (
            <form className={formClasses} onSubmit={this.props.onSubmit}>
                <input className="name" name="name" type="text" placeholder="Meal name" onChange={this.handleNameChange}/>
                <input className="calories" name="calories" type="number" placeholder="Calories" onChange={this.handleCaloriesChange}/><br/>
